            ...
            <div className='single-recipe__intro'>
                {demoRecipe.image && (
                    <figure className='single_recipe__image'>
                        ...
                        />
                        <p className='single_recipe__image-source'><small>Image © <a href={demoRecipe.sourceUrl} target='_blank'>{domain.hostname.replace('www.', '')}</a></small></p>
                    </figure>
                )}
                <div className='single-recipe__content'>
                    ...
                    {demoRecipe.sourceUrl && (
                        <p className='single-recipe__source'><small>Original source: <a href={demoRecipe.sourceUrl} target='_blank'>{demoRecipe.sourceUrl}</a></small></p>
                    )}
                </div>
            </div>
                                ...
                                {demoRecipe.servings && (
                                    <div className='ingredients__servings'>
                                        ...
                                        <div className='buttons'>
                                            <Button size='btn-sm' customClick={() => {
                                                if (recipeServings > 1) {
